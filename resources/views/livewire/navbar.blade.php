...
>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center w-full">
        <h1 class="text-2xl font-extrabold text-gray-900 cursor-pointer select-none">Raymond</h1>
    ...
    <div
        ...
        class="md:hidden absolute top-full left-0 w-full bg-amber-50 shadow-lg border-b border-black"
